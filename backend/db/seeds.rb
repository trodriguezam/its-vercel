...
task1 = Task.create(name: "DCL Simple", topic_id: topic.id, task_type: "Development", difficulty: 1)
task2 = Task.create(name: "DCL Complejo", topic_id: topic.id, task_type: "Development", difficulty: 2)
